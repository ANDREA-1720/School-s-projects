/*
    ...
    Classe: 3ESA
    Descrizione: "20251204-3esa-Perciabosco-ordinamento-bolle3D"
*/
...
int main() {
  ...
  for (indice = dati - 1; indice > 0; indice--) {
    scambiato = false;
    for (indice2 = indice; indice2 > 0; indice2--) {
      if (vetnum[indice2 - 1] > vetnum[indice2]) {
